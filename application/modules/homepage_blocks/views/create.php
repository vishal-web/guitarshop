...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			...
			<a href="<?= base_url() ?>homepage_blocks/deleteconf/<?=$update_id?>"><button type="button" class="btn btn-danger">Delete Entire Offers</button></a>			
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<?php
				$form_url = base_url().'homepage_blocks/create/'.$update_id;
			?>
