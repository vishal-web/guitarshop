...
function _attempt_draw_slider()
{
    ...
    if ($num_rows_ads>0) {
        ...
        // we need to draw sliders on this page
...
{
    // delete any slides that are associated with this sliders
    $this->load->module('slides');
...
function delete($update_id)
{
    ...
    if ($submit == 'Cancel') {
        ...
        $msg = 'The slider was successfully Deleted';
    ...
    if ($submit == 'Submit') {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (is_numeric($update_id)) {
                ...
                $msg = 'The slider details was successfully Updated';
                $value = '<div class="alert alert-success">'.$msg.'</div>';
                ...
                $msg = 'The slider was successfully created';
                $value = '<div class="alert alert-success">'.$msg.'</div>';
                $this->session->set_flashdata('homepage_offer',$value);
                redirect('sliders/create/'.$update_id);
            }
