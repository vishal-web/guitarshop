					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="<?= base_url()?>adminfiles/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<?= Modules::run('store_order_status/_draw_left_nav_links')?>
						...
						<li><a href="<?= base_url()?>btm_nav/manage"><i class="icon-briefcase"></i><span class="hidden-tablet"> Bottom Navigations</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
